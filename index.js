...
const dot_5 = document.querySelector("#module_5_dot")
const dot_6 = document.querySelector("#module_6_dot")
const dot_7 = document.querySelector("#module_7_dot")
const dot_8 = document.querySelector("#module_8_dot")
...
const hexagon_5 = document.getElementById("m_5_hexagon")
const hexagon_6 = document.getElementById("m_6_hexagon")
const hexagon_7 = document.getElementById("m_7_hexagon")
const hexagon_8 = document.getElementById("m_8_hexagon")
...
const icon_5 = document.getElementById("m_5_icon")
const icon_6 = document.getElementById("m_6_icon")
const icon_7 = document.getElementById("m_7_icon")
const icon_8 = document.getElementById("m_8_icon")
...
const line_8 = document.querySelector("#line_8")
...
const year_5 = document.querySelector("#year_5")
const year_6 = document.querySelector("#year_6")
const year_7 = document.querySelector("#year_7")
const year_8 = document.querySelector("#year_8")
...
function animation_over(target) {
    ...
    else if(t_id.indexOf('5') !== -1){
      console.log('dot 5 mouse over')
      hexagon_5.classList.add('hexagon_hover_5')
      icon_5.classList.add('icon_hover')
      line_5.classList.add('line_hover')
      year_5.classList.add('year_hover')
      info_5.classList.add('info_hover')
    }

    else if(t_id.indexOf('6') !== -1){
      console.log('dot 6 mouse over')
      hexagon_6.classList.add('hexagon_hover_6')
      icon_6.classList.add('icon_hover')
      line_6.classList.add('line_hover')
      year_6.classList.add('year_hover')
      info_6.classList.add('info_hover')
    }

    else if(t_id.indexOf('7') !== -1){
      console.log('dot 7 mouse over')
      hexagon_7.classList.add('hexagon_hover_7')
      icon_7.classList.add('icon_hover')
      line_7.classList.add('line_hover')
      year_7.classList.add('year_hover')
      info_7.classList.add('info_hover')
    }
    
    else if(t_id.indexOf('8') !== -1){
      console.log('dot 8 mouse over')
      hexagon_8.classList.add('hexagon_hover_8')
      icon_8.classList.add('icon_hover')
      line_8.classList.add('line_hover')
      year_8.classList.add('year_hover')
      info_8.classList.add('info_hover')
    }
}
...
function animation_out() {
        ...
        hexagon_5.className = "hexagon"
        hexagon_6.className = "hexagon"
        hexagon_7.className = "hexagon"
        hexagon_8.className = "hexagon"

        icon_1.className = "module_icon"
        icon_2.className = "module_icon"
        icon_3.className = "module_icon"
        icon_4.className = "module_icon"
        icon_5.className = "module_icon"
        icon_6.className = "module_icon"
        icon_7.className = "module_icon"
        icon_8.className = "module_icon"

        line_1.className = "line"
        line_2.className = "line"
        line_3.className = "line"
        line_4.className = "line"
        line_5.className = "line"
        line_6.className = "line"
        line_7.className = "line"
        line_8.className = "line"
        
        year_1.className = "year"
        year_2.className = "year"
        year_3.className = "year"
        year_4.className = "year"
        year_5.className = "year"
        year_6.className = "year"
        year_7.className = "year"
        year_8.className = "year"

        info_1.className = "info"
        info_2.className = "info"
        info_3.className = "info"
        info_4.className = "info"
        info_5.className = "info"
        info_6.className = "info"
        info_7.className = "info"
        info_8.className = "info"
...
function init() {
    ...
    hexagon_5.addEventListener('mouseover', animation_over)
    hexagon_5.addEventListener('mouseout', animation_out)
    hexagon_6.addEventListener('mouseover', animation_over)
    hexagon_6.addEventListener('mouseout', animation_out)
    hexagon_7.addEventListener('mouseover', animation_over)
    hexagon_7.addEventListener('mouseout', animation_out)
    hexagon_8.addEventListener('mouseover', animation_over)
    hexagon_8.addEventListener('mouseout', animation_out)
    console.log('on load')
}
